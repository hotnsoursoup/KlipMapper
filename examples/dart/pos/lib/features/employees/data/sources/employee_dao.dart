// lib/features/employees/data/sources/employee_dao.dart
...
import '../tables/employee_service_categories.dart';
...
class EmployeeDao extends DatabaseAccessor<PosDatabase> with _$EmployeeDaoMixin {
  ...
  Future<List<Employee>> getEmployeesByCategory(String categoryId) {
    return (select(employees)
      .join([
